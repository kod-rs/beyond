from playground.backend_old.api.cqrs_c.portfolio_colour_adapter import add_color_to_log
from playground.backend_old.api.model.portfolio import Portfolio
from playground.backend_old.api.comm.constants import EXISTS, NOT_EXISTS
