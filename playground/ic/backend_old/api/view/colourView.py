...
from playground.ic.backend_old.api.cqrs_c.portfolio_colour_adapter import \
...
class ColourView(APIView):
    ...
    def delete(self, request, name):
        ...
        response["payload"] = delete_portfolio_colour_entries(
    ...
    def post(self, request, name):
        ...
        response["payload"] = add_color_to_log(request.username, portfolio,
                                               name)
        return JsonResponse(response)
