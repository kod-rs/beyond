...
def add(start_time: str,
    ...
    """
    Saves  flexibility for a building to a database
...
def get_by_building_and_time(building_id: str,
    ...
    Returns:
        Either a list containing all the flexibilities matching the building
        and time or False in case of  no data found or error while reading data
    """
