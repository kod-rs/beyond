...
#             KeycloakMiddleware(Mock)(self.request)
#
#     def test_when_has_not_keycloak_client_secret_key_configuration_settings(
#             self):
...
#             KeycloakMiddleware(Mock)(self.request)
#
#     def test_when_some_URI_is_permitted_on_authentication_with_keycloak_roles_on_view(
#             self):
...
#
#     def test_when_some_URI_is_permitted_on_authentication_without_keycloak_roles_attribute_on_view(
#             self):
...
#
#     def test_when_realm_roles_and_client_roles_are_present_both_are_returned(
#             self):
#         fake_token = {
#             "realm_access": {
#                 "roles": [
